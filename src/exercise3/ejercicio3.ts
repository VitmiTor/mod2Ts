import productosJson from "./jsons/productos.json";
import pedidosJson from "./jsons/pedido.json";
import { crearMapProducto } from "./parser/productosParser";

const productoMap = crearMapProducto(productosJson);

const imprimirInfoProducto = (): void => {
